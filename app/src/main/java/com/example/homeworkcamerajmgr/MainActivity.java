package com.example.homeworkcamerajmgr;
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Método para abrir la camara de nuestro dispositivo
     * @param view
     */
    public void openCamera(View view) {
        //creamos una nueva intent la cual nos llevará a la camara
        Intent intentCamera = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        //verificamos que haya alguna aplicacion la cual pueda realizar este intent de abrir la camara
